--[[
    ...
    To save a stack you should save/load the items member instead of the stack class:
...
---@param value any
---@return boolean # True if value was found and pushed.
...
---ipairs metafunction for stack.
---@param stack Stack
---@return fun(table: any[], i: integer):integer, any
function StackClass.__ipairs(stack)
    return ipairs(stack.items)
end

---pairs metafunction for stack.
---@param stack Stack
---@return fun(table: table<integer, any>, index: integer):integer, any
function StackClass.__pairs(stack)
    return pairs(stack.items)
end
